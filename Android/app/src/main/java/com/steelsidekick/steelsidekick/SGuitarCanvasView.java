...
public class SGuitarCanvasView extends GLSurfaceView {
    ...
    public SGuitarCanvasView(Context context) {
        super(context);
        init(false, 0, 0);
    }

    public SGuitarCanvasView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(false, 0, 0);
    }

    public SGuitarCanvasView(Context context, boolean translucent, int depth, int stencil) {
        super(context);
    ...
    private void init(boolean translucent, int depth, int stencil) {
        ...
        setRenderer(new Renderer(getWidth(), getHeight()));
    }
